...
Irão ser utilizados conhecimento adquiridos no bootcamp nas tecnologias Node.js com TypeScript, banco de dados PostgreSQL com TypeORM e para upload de arquivos o Multer.
